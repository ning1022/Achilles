...
class Task(object):
    ...
    def engine_start(self):
        self.process = Popen(["python", "./AchillesClient/thirdparty/sqlmap/sqlmap.py", "--pickled-options", base64pickle(self.options)], shell=False, stdin=PIPE, close_fds=not IS_WIN)
